            ...
            <Dialog.Portal>
              ...
              >
                ...
                <Fieldset gap="$4" horizontal>
                  ...
                  <Input flex={1} id="number_token" placeholder="xx" onChange={(e: NativeSyntheticEvent<TextInputChangeEventData>) => {setTokenInput(parseInt(e.nativeEvent.text))}} />
                </Fieldset>
                ...
                <Fieldset gap="$4" horizontal>
                  ...
                  <Input flex={1} id="price_token" placeholder="xx,xx" />
                </Fieldset>

                <XStack alignSelf="flex-end" gap="$4">
                  <Dialog.Close displayWhenAdapted asChild>
                    <Button theme="accent" aria-label="Close" onPress={() => {setToken(token + tokenInput)}}>
                      Save changes
                    </Button>
                  </Dialog.Close>
                </XStack>
